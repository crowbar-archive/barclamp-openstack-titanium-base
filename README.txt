...
Thie barclamp is intended as an overlay barclamp for other OpenStack High-Availability barclamps.  It provides common functionality and UI that can be used to consolidate the suite of OpenStack barclamps under a single entity. 
